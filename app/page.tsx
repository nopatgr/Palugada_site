...
export default function LandingPage() {
  ...
  const services = [
    { id: "os-install", name: "OS Reinstallation", duration: "2-3 hours", price: "$99" },
    { id: "software-install", name: "Software Installation", duration: "1-2 hours", price: "$59" },
    { id: "tech-support", name: "Technical Support", duration: "1 hour", price: "$79" },
    { id: "cv-writing", name: "CV/Resume Creation", duration: "3-5 days", price: "$149" },
    { id: "academic-writing", name: "Academic Writing", duration: "1-2 weeks", price: "$299" },
    { id: "portfolio-website", name: "Portfolio Website", duration: "1-2 weeks", price: "$499" },
  ]
        ...
        <div className="relative max-w-7xl mx-auto text-center">
          <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            <h1 className="text-4xl sm:text-6xl lg:text-7xl font-bold mb-6">
              ...
              <br />
              <span className="text-slate-300 text-3xl sm:text-4xl lg:text-5xl">for Your Everyday Needs</span>
            </h1>
          </motion.div>
          ...
          >
            From system installations to professional writing services, we deliver reliable, expert solutions that save
            you time and ensure quality results.
          </motion.p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-slate-400 max-w-2xl mx-auto">
              Comprehensive digital solutions tailored to meet your personal and professional needs
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description: "Professional Windows and Linux system installation and configuration",
              },
              {
                icon: Download,
                title: "Software Installation",
                description: "Office 365, antivirus, PDF tools, and essential software setup",
              },
              {
                icon: Headphones,
                title: "Technical Support",
                description: "Remote and on-site technical assistance for all your IT needs",
              },
              {
                icon: FileText,
                title: "CV/Resume Creation",
                description: "Professional resume writing that gets you noticed by employers",
              },
              {
                icon: GraduationCap,
                title: "Academic Writing",
                description: "Expert thesis and proposal writing services for students",
              },
              {
                icon: Globe,
                title: "Portfolio Websites",
                description: "Custom portfolio website development to showcase your work",
              },
            ].map((service, index) => (
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-xl text-slate-400 mb-8 max-w-2xl mx-auto">
              Join hundreds of satisfied customers who trust DigitalPro for their digital needs. Let's discuss how we
              can help you today.
            </p>
            <Button
              size="lg"
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <p className="text-slate-400 mb-6 max-w-md">
                Your trusted partner for professional digital solutions. We deliver quality, reliability, and expertise
                in every project.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-3 text-slate-400">
                <li className="flex items-center">
                  ...
                  <span>palugadasolutionservice@gmail.com</span>
                </li>
                <li className="flex items-center">
                  <Phone className="h-5 w-5 mr-2" />
                  <span>+6285777101676</span>
                </li>
                <li className="flex items-center">
                  <MapPin className="h-5 w-5 mr-2" />
                  <span>Cibitung, Bekasi</span>
                </li>
              </ul>
            </div>
          </div>
      ...
      <Dialog open={isBookingOpen} onOpenChange={setIsBookingOpen}>
        <DialogContent className="bg-slate-900 border-slate-700 text-white max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <button onClick={resetBooking} className="absolute right-4 top-4 text-slate-400 hover:text-white">
              <X className="h-6 w-6" />
            </button>
          </DialogHeader>
                    ...
                    {step < 3 && (
                      <div
                        className={`w-12 h-0.5 mx-2 ${
                          bookingStep > step ? "bg-gradient-to-r from-blue-600 to-purple-600" : "bg-slate-700"
                        }`}
                      />
                    )}
                  </div>
                      ...
                      >
                        <div className="flex justify-between items-center">
                          <div>
                            ...
                            <p className="text-sm text-slate-400">Duration: {service.duration}</p>
                          </div>
                ...
                <motion.div initial={{ opacity: 0, x: 20 }} animate={{ opacity: 1, x: 0 }} className="space-y-4">
                  ...
                  <div className="bg-slate-800 p-4 rounded-lg">
                    ...
                    <div className="space-y-1 text-sm text-slate-300">
                      ...
                      <p>
                        <span className="text-slate-400">Date:</span> {new Date(bookingData.date).toLocaleDateString()}
                      </p>
                      <p>
                        <span className="text-slate-400">Time:</span> {bookingData.time}
                      </p>
                      <p>
            ...
            >
              ...
              <div className="bg-slate-800 p-6 rounded-lg mb-6">
                ...
                <div className="space-y-2 text-left">
                  ...
                  <p>
                    <span className="text-slate-400">Contact:</span> {bookingData.email}
                  </p>
                </div>
              </div>
              <p className="text-slate-400 mb-6">
                We've sent a confirmation email to {bookingData.email}. Our team will contact you within 24 hours to
                confirm the details.
              </p>
              <Button
